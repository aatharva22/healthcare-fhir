...
def create_Condition(condition:Condition_Create, db : Session = Depends(get_db)):
...
def update_Condition(id:str, condition:Condition_Create, db:Session = Depends(get_db)):
